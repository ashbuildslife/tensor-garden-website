      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              <h2 className="heading-lg gradient-text mb-6 dark:text-white">Our Story</h2>
            ...
            <div>
              <h2 className="heading-lg gradient-text mb-6 dark:text-white">Our Mission</h2>
              <div className="space-y-4 text-gray-600 dark:text-gray-300">
                <p>
                ...
                <ul className="space-y-2 list-disc pl-5 dark:text-gray-300">
          ...
          <div className="mt-20">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              <Card className="overflow-hidden dark:border-gray-700">
                <div className="aspect-[3/2] bg-gray-100 dark:bg-gray-800"></div>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-1 dark:text-white">Ashish Vaja</h3>
                  <p className="text-teal-600 dark:text-teal-400 font-medium mb-4">Co-Founder & Business Strategy</p>
              ...
              <Card className="overflow-hidden dark:border-gray-700">
                <div className="aspect-[3/2] bg-gray-100 dark:bg-gray-800"></div>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-1 dark:text-white">Antonio Pernicano</h3>
                  <p className="text-teal-600 dark:text-teal-400 font-medium mb-4">Co-Founder & Technology Lead</p>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">
          ...
          <div className="mt-20">
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <Card className="card-shadow dark:border-gray-700">
                <CardContent className="p-6">
                  <div className="rounded-full bg-teal-100 dark:bg-teal-900 h-12 w-12 flex items-center justify-center mb-4">
                    <span className="text-teal-600 dark:text-teal-400 text-lg font-bold">1</span>
                  </div>
                  <h3 className="text-lg font-semibold mb-3 dark:text-white">Insurance Industry Focus</h3>
                  <p className="text-gray-600 dark:text-gray-300">
              ...
              <Card className="card-shadow dark:border-gray-700">
                <CardContent className="p-6">
                  <div className="rounded-full bg-teal-100 dark:bg-teal-900 h-12 w-12 flex items-center justify-center mb-4">
                    <span className="text-teal-600 dark:text-teal-400 text-lg font-bold">2</span>
                  </div>
                  <h3 className="text-lg font-semibold mb-3 dark:text-white">Practical Solutions</h3>
                  <p className="text-gray-600 dark:text-gray-300">
              ...
              <Card className="card-shadow dark:border-gray-700">
                <CardContent className="p-6">
                  <div className="rounded-full bg-teal-100 dark:bg-teal-900 h-12 w-12 flex items-center justify-center mb-4">
                    <span className="text-teal-600 dark:text-teal-400 text-lg font-bold">3</span>
                  </div>
                  <h3 className="text-lg font-semibold mb-3 dark:text-white">End-to-End Support</h3>
                  <p className="text-gray-600 dark:text-gray-300">
              ...
              <Card className="card-shadow dark:border-gray-700">
                <CardContent className="p-6">
                  <div className="rounded-full bg-teal-100 dark:bg-teal-900 h-12 w-12 flex items-center justify-center mb-4">
                    <span className="text-teal-600 dark:text-teal-400 text-lg font-bold">4</span>
                  </div>
                  <h3 className="text-lg font-semibold mb-3 dark:text-white">Flexible Engagement Models</h3>
                  <p className="text-gray-600 dark:text-gray-300">
              ...
              <Card className="card-shadow dark:border-gray-700">
                <CardContent className="p-6">
                  <div className="rounded-full bg-teal-100 dark:bg-teal-900 h-12 w-12 flex items-center justify-center mb-4">
                    <span className="text-teal-600 dark:text-teal-400 text-lg font-bold">5</span>
                  </div>
                  <h3 className="text-lg font-semibold mb-3 dark:text-white">Proven Results</h3>
                  <p className="text-gray-600 dark:text-gray-300">
              ...
              <Card className="card-shadow dark:border-gray-700">
                <CardContent className="p-6">
                  <div className="rounded-full bg-teal-100 dark:bg-teal-900 h-12 w-12 flex items-center justify-center mb-4">
                    <span className="text-teal-600 dark:text-teal-400 text-lg font-bold">6</span>
                  </div>
                  <h3 className="text-lg font-semibold mb-3 dark:text-white">Innovation Partnership</h3>
                  <p className="text-gray-600 dark:text-gray-300">
