            ...
            <div className="grid md:grid-cols-2">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                <EditableContent
                  ...
                  type="text"
                >
                  <h3 className="heading-md mb-4 text-gray-900 dark:text-white font-bold">
                    {featuredCaseStudy?.title || 'Quoting Automation'}
                  </h3>
                </EditableContent>
                ...
                <EditableContent
                  ...
                  type="text"
                >
                  <div className="bg-teal-100 text-teal-800 dark:bg-teal-900 dark:text-teal-200 px-4 py-2 rounded-full inline-block text-sm font-medium mb-4">
              ...
              <div className="bg-purple-100 dark:bg-purple-900/30 md:h-auto">
                <div className="h-full flex items-center justify-center p-8">
                  <div className="text-center">
                    <div className="text-5xl font-bold text-purple-600 dark:text-purple-300 mb-2">100+</div>
                    <p className="text-purple-800 dark:text-purple-200 font-medium">Hours saved monthly</p>
                  </div>
                  <div className="mx-8 h-16 border-r border-purple-300 dark:border-purple-700"></div>
                  <div className="text-center">
                    <div className="text-5xl font-bold text-purple-600 dark:text-purple-300 mb-2">3x</div>
                    <p className="text-purple-800 dark:text-purple-200 font-medium">Faster quote turnaround</p>
                  </div>
                </div>
              </div>
            </div>
